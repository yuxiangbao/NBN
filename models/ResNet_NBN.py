...
from models.ResNext_NBN import BatchNorm2d
...
def resnet50_nbn(num_classes=1000, **kw):
    print('Loading Scratch ResNet 50 not scale conv  Model.')
    resnet_scale = ResNet_NBN(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, **kw) 
    return resnet_scale
